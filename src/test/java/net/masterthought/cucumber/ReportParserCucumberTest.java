...
public class ReportParserCucumberTest {
    ...
    public void shouldReturnAListOfFeaturesFromAJsonReport() throws IOException {
        ...
        assertThat(reportParser.getFeatures().entrySet().iterator().next().getValue().get(0), is(FeatureCucumber.class));
        assertThat(reportParser.getFeatures().entrySet().iterator().next().getValue().get(1), is(FeatureCucumber.class));
    }
